...
Multi-language supported Team Members - Team with Slide is the best plugins to display unlimited team in Carouse and Grid view. The Team Members - Team with Slide plugin comes with 38+ team design layouts.

== Description ==
https://www.youtube.com/watch?v=1FRc00QT0rc

[Live Demo](https://www.wpmart.org/team-showcase-supreme-demo/) | [Support](https://wordpress.org/support/plugin/team-showcase-supreme/) | [Upgrade to Pro](https://wpmart.org/downloads/team-member/)

<strong>Multi-language supported Team Members with Slider</strong> is a responsive and mobile-friendly WordPress team making plugin that has some amazing features to make an amazing team showcase. Using this plugin, you can display your team members in a different layout like Grids and Sliders. It is very powerful yet lightweight team member plugin which allows you to decorate your team, support, contacts, about us or staff page with ease of customization. You can add, customize and showcase your team with responsive slider. While using this plugin, you’ll find Team Showcase with Slider the faster and simpler way to add and showcase your team member within your webpage.

== How to use Team Member – Multi Language Supported Team Plugin ==
...
= Is the Team Member plugin support multi-language? =

Yes, It’s support all multi-language plugins like WPML, Translate WordPress with GTranslate, Loco Translate, Translate Multilingual sites – TranslatePress, Translate WordPress – Google Language Translator, etc.
...
1. Member details template demo 1
2. Member details template demo 2
3. Member details template demo 3
4. Team Showcase with Slider Template Demo 1
5. Team Showcase with Slider Template Demo 2
6. Team Showcase with Slider Template Demo 3


== Changelog ==
= 7.1 =
* FEATURE – More options added in the editor 

= 7.0 =
* FEATURE – CSS Fixing

= 6.9 =
* FEATURE – Fixed Skill limit

= 6.8 =
* FEATURE – Rearrange feature added

= 6.7 =
* FEATURE – Fixed details template CSS
...
= 6.0 =
* Profile details templates added

= 5.8 =
* FEATURE – CSS Fixing

= 5.7 =
* FEATURE – Update Font Awesome
